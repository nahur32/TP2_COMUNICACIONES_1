...
%   \tableofcontents %Para el indice
    \include{parte_teorica/Actividad_1} %llama los otros 
	\include{parte_teorica/Actividad_2}
	%\include{parte_teorica/Actividad_3}
	%\include{parte_teorica/Actividad_4}
	\include{parte_teorica/Actividad_5}
	\include{parte_teorica/Actividad_6}
	%\include{parte_teorica/Actividad_7}
	%\include{parte_teorica/Actividad_8}
